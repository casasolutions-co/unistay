        ...
        <div className={styles.page}>
          ...
          <nav className={styles.nav}>
            ...
            <div className={styles.navLinks}>
              ...
              <a href="/register" className={styles.navCta}>Login / Register</a>
            </div>
          </nav>
          ...
          <div className={styles.split}>
            ...
            <div className={styles.imagePanel}>
              ...
              <div className={styles.imageContent}>
                ...
                <h2 className={styles.imageHeadline}>Elevated living for the global student.</h2>
                <p className={styles.imageSub}>Carefully curated spaces across Germany, designed for students who expect more.</p>
              </div>
            </div>
            ...
            <div className={styles.formPanel}>
              <div className={styles.formInner}>
                ...
                <p className={styles.subline}>Sign in to manage your stays and explore listings.</p>

                {/* Email */}
                <label className={styles.label}>Email address</label>
                <div className={styles.fieldWrap}>
                  <span className={styles.fieldIcon} style={{ color: email ? '#6d28d9' : '#b0aabf' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className={styles.fieldWrapPw}>
                  <span className={styles.fieldIcon} style={{ color: password ? '#6d28d9' : '#b0aabf' }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Sign In */}
                <button type="button" className={styles.submitBtn} onClick={handleEmailLogin} disabled={loading}>
                ...
                <p className={styles.footerText}>
                  ...
                  <a href="/register" className={styles.link}>Create one for free</a>
                </p>
                <p className={styles.legalText}>
                  By continuing, you agree to UniStay&apos;s{' '}
                  <button type="button" onClick={() => openLegal('terms')} className={styles.legalLink} style={{ background: 'none', border: 'none', padding: 0, font: 'inherit', cursor: 'pointer' }}>Terms</button> and{' '}
